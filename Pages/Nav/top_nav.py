...
top_nav = html.Div([
    dcc.Tabs(id="tabs-styled-with-inline", value='tab-1', children=[
        ...
        dcc.Tab(label='Data Correlation', value='tab-3', style=tsc.tab_style, selected_style=tsc.tab_selected_style),
        dcc.Tab(label='Hypothesis Testing', value='tab-4', style=tsc.tab_style, selected_style=tsc.tab_selected_style),
